...
function installPolyfill() {
    var _a, _b;
    const noDocumentConstructionObserver = !!((_a = priorCustomElements) === null || _a === void 0 ? void 0 : _a['noDocumentConstructionObserver']);
    const shadyDomFastWalk = !!((_b = priorCustomElements) === null || _b === void 0 ? void 0 : _b['shadyDomFastWalk']);
    const internals = new CustomElementInternals({ noDocumentConstructionObserver, shadyDomFastWalk });
